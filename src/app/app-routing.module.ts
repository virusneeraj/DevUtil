...
import {Base64EncComponent} from "./pages/encdec/base64/text/base64-enc/base64-enc.component";
import {Base64TextComponent} from "./pages/encdec/base64/text/base64-text/base64-text.component";
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'charts/chartjs', component: ChartjsComponent, data: {extraParameter: ''}},
        ...
        {path: 'encdec/base64/text', component: Base64TextComponent, data: {extraParameter: ''}},
